...
if (isNode) {
    ...
    // Not sure with this??? for MOAC
    var canImprove = function(nodeVer) {
        return 'can improve chain3\'s peformance when running Node.js versions older than ' + nodeVer + ' by installing the (deprecated) scrypt package in your project';
    };
