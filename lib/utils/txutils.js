...
exports.rlphash = function (a) {
  return exports.sha3(exports.encode(a))
}
 ...
 * @param {Buffer} r
 * @param {Buffer} s
 * @param {Boolean} [_pangu=true]
 * @return {Boolean}
 */

exports.isValidSignature = function (v, r, s, _pangu) {
  ...
  if ((_pangu === false) && (new BN(s).cmp(SECP256K1_N_DIV_2) === 1)) {
    return false
  }
 ...
 * Meet some issues about handling input string as bignumber int
 * 
 */
exports.defineProperties = function (self, fields, data) {
  ...
  self.serialize = function serialize () {
    return exports.encode(self.raw)
  }
...
/*
 * Encode the Transaction structure with RLP
 * Updated to 
 * 
*/
 ...
 * @return {String}
 */
exports.BigIntToHex = function (i) {
