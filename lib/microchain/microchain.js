...
var addDappFunctions = function (mcdapp) {
    ...
    console.log("==================================");
    console.log(mcdapp.abi.length, mcdapp.abi[0]);
    console.log("==================================");
 ...
 * 
 */
MicroChain.prototype.getDappBase = function (inbaseabi, inAddress, callback) {

console.log("Return DappBase Obj at:", inAddress);
  ...
  // dappAddrList =  this._scs.getDappAddrList(this.address);
  ...
  //   var dappBaseAddress = dappAddrList[0];
    ...
    var mcBase = new DappBase.DappBase(this._mc, this._scs, inbaseabi, inAddress, this.via);
