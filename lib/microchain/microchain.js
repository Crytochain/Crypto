 ...
 * 
 */
MicroChain.prototype.getDappBase = function (inMcAddress, inbaseabi, inAddress, callback) {

console.log("Return DappBase Obj on ", inMcAddress, " at:", inAddress);
  ...
  //   var dappBaseAddress = dappAddrList[0];
    ...
    var mcBase = new DappBase.DappBase(this._mc, this._scs, inMcAddress, inbaseabi, inAddress, this.via);
