...
var DappBase = function (mc, scs, inAbi, inAddress, viaAddress) {
    ...
    this.address = inAddress; //MicroChain address, need to use for every function calls
    this.baseAddress = null;// dappbase address, this need to be extracted using MicroChain address
    this.dappAddress = null;// dapp address, need to be registered with dappbase, may not need 
    this.abi = inAbi;
    this.via = viaAddress;
};
