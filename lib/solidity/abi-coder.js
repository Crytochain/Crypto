...
var constants_1 = require("./abi-constants");
var errors = __importStar(require("./abi-errors"));
var address_1 = require("./abi-address");
var bignumber_1 = require("./abi-bignumber");
var bytes_1 = require("./abi-bytes");
var utf8_1 = require("./abi-utf8");
var properties_1 = require("./abi-properties");
///////////////////////////////
...
var CoderFixedBytes = /** @class */ (function (_super) {
    ...
    CoderFixedBytes.prototype.encode = function (value) {
        ...
        try {
            console.log("abi-coder: Arra value:", value);
            var data = bytes_1.arrayify(value);
            console.log("abi-coder: data:", data, this.length);
            if (data.length !== this.length) {
                console.log("mismatch data.length",data.length, this.length);
                // This could cause error 
               throw new Error('incorrect data length');
            }
            console.log("abi-coder: Data length:", data.length, this.length, result.length);
            result.set(data);
        }
        catch (error) {
