...
ABICoder.prototype.encodeFunctionSignature = function (functionName) {
    ...
    return '0x'+sha3(functionName).slice(0, 10);
};
...
ABICoder.prototype.encodeParameters = function (types, params) {
    console.log("mapTypes", this.mapTypes(types));
...
ABICoder.prototype.encodeFunctionCall = function (jsonInterface, params) {
    console.log("encodeFunctionSignature:", this.encodeFunctionSignature(jsonInterface));
    console.log("encodeParameters:", this.encodeParameters(jsonInterface.inputs, params));
