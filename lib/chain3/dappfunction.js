 ...
 */
var DappFunction = function (mc, scs, json, address) {
    this._mc = mc;
    this._scs = scs;
    ...
    this._from = mc.coinbase;
    this._via = null;//need to be set before sendTransaction call
...
DappFunction.prototype.sendTransaction = function () {
    ...
    if (payload.shardingFlag != 1)
    {
        ...
        payload.via = "0xa8863fc8ce3816411378685223c03daae9770ebb"
    }
