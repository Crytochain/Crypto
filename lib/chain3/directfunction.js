...
/**
 * Calls a Dapp function by using arguments
 * and send to the 
 *
 * @method call
...
DirectFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = this._scs.getAnyCallReq(payload, defaultBlock);
        return this.unpackOutput(output);
    }

    //Asyn callback
    var self = this;
    this._scs.getAnyCallReq(payload, defaultBlock, function (error, output) {
...
/**
 * Should be used to sendTransaction to SCS
 * MicroChain function
 *
...
payload.from = '0xa8863fc8ce3816411378685223c03daae9770ebb';
    if (!callback) {
