...
var AppChain = require('./appchain/appchain');
...
// AppChain object 
// inabi.    - ABI to call the AppChain, refer to standard types, AST or ASM
// inAddress - AppChain address, should be generated from deploy process
Chain3.prototype.appchain = function (inabi, inAddress) {
    
    var appChain = new AppChain(this.mc, this.scs, inabi);
    return appChain;
};
