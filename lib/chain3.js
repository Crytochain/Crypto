...
var McDapp = require('./chain3/dapp');
var abicoder = require('./solidity/abi');
...
function Chain3 (provider,scsProvider) {
    ...
    //Added web3.js 1.0.0 functions
    // this.abi = abicoder;//new abicoder(this);
...
Chain3.prototype.dapp = function (inabi) {
    var microDapp = new McDapp(this.mc, this.scs, inabi);
    return microDapp;
};

//MicroChain constructor object
Chain3.prototype.microchain = function (inName, inAddress) {
    if (inName == 'AST'){
        //Used the MicroChain with 
        var mcChain = new MicroChain(this.mc, this.scs, inName);
        return mcChain;
    }else if (inName == 'ASM' ){
...
Chain3.prototype.verifyMcSignature = account.verifyMcSignature;
Chain3.prototype.signMcMessage = account.signMcMessage;
Chain3.prototype.abicoder = abicoder;
