...
describe('lib/chain3/method', function () {
    describe('buildCall', function () {
        it('should return a promise and resolve it', function (done) {
            ...
            method.setRequestManager(mc._requestManager);
        ...
        it('should fill in gasPrice if not given', function (done) {
            ...
            method.setRequestManager(mc._requestManager, mc);
        ...
        var succeedwhenDeploying = function () {
            ...
            method.setRequestManager(mc._requestManager); // second parameter accounts
